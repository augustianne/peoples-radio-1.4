...
abstract class BaseChannelPeer {
	...
	/** the column name for the ICECAST_PORT field */
	const ICECAST_PORT = 'channel.ICECAST_PORT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'IcecastPort', 'Port', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'icecastPort', 'port', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ICECAST_PORT, self::PORT, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'icecast_port', 'port', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'IcecastPort' => 2, 'Port' => 3, 'Slug' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'icecastPort' => 2, 'port' => 3, 'slug' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ICECAST_PORT => 2, self::PORT => 3, self::SLUG => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'icecast_port' => 2, 'port' => 3, 'slug' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ChannelPeer::ICECAST_PORT);
