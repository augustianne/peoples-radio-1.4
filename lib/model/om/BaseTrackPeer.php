...
abstract class BaseTrackPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Filename', 'Name', 'Artist', 'Time', 'Genre', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'filename', 'name', 'artist', 'time', 'genre', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FILENAME, self::NAME, self::ARTIST, self::TIME, self::GENRE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'filename', 'name', 'artist', 'time', 'genre', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Filename' => 1, 'Name' => 2, 'Artist' => 3, 'Time' => 4, 'Genre' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'filename' => 1, 'name' => 2, 'artist' => 3, 'time' => 4, 'genre' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FILENAME => 1, self::NAME => 2, self::ARTIST => 3, self::TIME => 4, self::GENRE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'filename' => 1, 'name' => 2, 'artist' => 3, 'time' => 4, 'genre' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
